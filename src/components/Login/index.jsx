...
<Form onSubmit={handleSubmit} className="flex flex-col gap-4 p-4 sm:p-6 rounded-lg items-center mx-auto mt-4">
  ...
  <div className="flex w-full flex-col mb-4">
    <label htmlFor="email" className="text-[1rem] sm:text-[1.25rem] leading-[1.25rem] sm:leading-[1.5rem] text-left mb-2 font-bold">
      Email
    </label>
    <Field name="email">
      {({ field }) => (
  ...
  {/* Password Field */}
  <div className="flex w-full flex-col mb-4">
    <label htmlFor="password" className="text-[1rem] sm:text-[1.25rem] leading-[1.25rem] sm:leading-[1.5rem] text-left mb-2 font-bold">
      Password
    </label>
    <Field name="password">
      {({ field }) => (
  ...
  <Link href="/">
    <Button
      ...
      text="Login"
      colorClass={`z-[3] mt-6 items-center bg-[#9747FF] font-semibold text-center px-5 sm:px-10 justify-center overflow-hidden relative text-[#FFFFFF] uppercase py-3 sm:py-4 rounded-full mx-auto ${
